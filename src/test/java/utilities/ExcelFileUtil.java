...
public class ExcelFileUtil {
	...
	public static void main(String[] args) throws Throwable {
		ExcelFileUtil xl = new ExcelFileUtil("C:\\Users\\Sudhakar\\Hybrid_frameworks\\StockAccounting_Project\\FileInput\\Sample.xlsx");
		...
		for(int i=1;i<=rc;i++)
		{
			...
			xl.setCellData("Empdata", i, 4, "Blocked", "C:\\Users\\Sudhakar\\Hybrid_frameworks\\StockAccounting_Project\\FileOutput\\Results.xlsx");
		}
	}
}
